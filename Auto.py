...
class Line:
    def __init__(self, s = (0, 0), e = (1, 1), color = (255, 0, 0)):
        self.start = Vector()
        self.start.set(s)
        self.end = Vector()
        self.end.set(e)
    ...
    def draw(self, display):
        pygame.draw.line(display, self.color,
                        ...
                        [int(self.end.x), int(self.end.y)], 1)
...
class Viewer:
    def __init__(self, display = pygame.display.set_mode((800, 400)), size = (20, 10), pos = (-5, -5)):
...
class TargetViewer(Viewer):
    def __init__(self, target = (0, 0), display = pygame.display.set_mode((800, 800)), size = (800, 800), pos = (-400, -400)):
        Viewer.__init__(self, display, size, pos)
        self.target = Vector()
    ...
    def updatePos(self, target = None):
        ...
        self.pos.mult((0, 0))
        self.pos.sub(self.size)
        self.pos.div((2, 2))
        self.pos.add(self.target)
...
class AutoBrain:
    def __init__(self, auto):
        ...
        self.input = []
        self.dense1 = Dense(7, 6, relu)
        self.dense2 = Dense(6, 4, relu)
...
class Auto(RaceCar):
    ...
    def getInputs(self):
        ...
        angles = [-45, -22.5, -11, 0, 11, 22.5, 45]
        inputs = []
    ...
    def update(self):
        ...
        self.body.color = (0, 255, 255) if self.top else (51, 51, 51)
...
class RaceTrack:
    ...
    def generateTrack(self, boundingRect, width):
        ...
        verts = hull.vertices[::-1] if random.randint(0, 1) == 1 else hull.vertices
